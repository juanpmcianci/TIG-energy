...
\]
\item \textbf{Generate AR(1) residuals} $\eta_{i,t}$: for each node $i$, initialize $\eta_{i,0}=0$ and evolve
\[
\eta_{i,t} = \rho_{\mathrm{AR}}\,\eta_{i,t-1} + \sqrt{1-\rho_{\mathrm{AR}}^2}\cdot 2\,z_{i,t}, \qquad z_{i,t}\sim\mathcal{N}(0,1),
\]
with $\rho_{\mathrm{AR}}=0.8$.
\item \textbf{Assemble nodal prices}:
\[
\lambda^{\mathrm{DA}}_{i,t} = \max\bigl\{\lambda_{\mathrm{DA,min}},\;\bar{\lambda}_t + \delta_i + \eta_{i,t}\bigr\}.
\]
\end{enumerate}
